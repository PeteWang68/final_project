...
From the sactter plot, a slightly positive association between median income and the hate crime rate is observed.
...
From the sactter plot, a negative association between share voters who voted Trump and the hate crime rate is observed. And the P-value is quite small, which indicates a significant association.