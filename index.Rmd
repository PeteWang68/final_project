...
-  To assess the relationship between hate crime and socioeconomic variables, we selected  various factors and collected data from the following sources:
...
- To compare the hate crime rate before and after the election, and explore whether Trump's election influenced hate crimes, we collected data from the following sources:
