...
## Exploratory Analysis 
  ...
  Next we found there was a change from 2016 to 2017 when it was the time for the election. We compare the hate crime rate for 10 days after the election(from 11.09.2016 - 11.18.2016) to the annual crime rate of 2016. This shows a great change. So we then change to see the relationship with share of the vote for Trump and the hate crime rate by state.
