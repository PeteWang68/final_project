...
## Data
  ...
  We first created a dataset containing the number of hate crime incidents and offenses from 2005 to 2017 by compiling the yearly hate crime data from the FBI data source. We excluded the number of victims and known offenders also offered by these datasets, since they were not releveant to our analysis. 
    Then, we create a dataset containing the number of hate crime in state division from 2005 to 2017, compling the relevent data from FBI data sourse. I only retain the number of hate crime and the total population covered in the dataset, and then caculate the hate crime rate per 100,000 population.
...
2017: https://ucr.fbi.gov/hate-crime/2017
   ...
   Next, we created the dataset containing several factors associate with the hate crime. The resource of the raw data of each factor is showing below:
